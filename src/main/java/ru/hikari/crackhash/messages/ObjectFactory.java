 ...
 * generated in the ru.hikari.crackhash package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.hikari.crackhash
     * 
     */
